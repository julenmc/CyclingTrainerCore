namespace CyclingTrainer.SessionAnalyzer.Core.Constants
{
    ...
    {
        public const float CvStartThrMinValue = 0.03f;      // STD/Avr relation threshold min value on interval start detection
        public const float CvStartThrMaxValue = 0.2f;
        public const float CvStartThrDefaultValue = 0.05f;
        ...
        public const float CvFollowThrDefaultValue = 0.1f;
        ...
        public const float RangeThrDefaultValue = 0.25f;
        ...
        public const float MaRelThrDefaultValue = 0.2f;  
    }
}