...
namespace SessionAnalyzer.Test.Irregular
{
    [TestClass]
    public class UpFinish
    {
        ...
        public void Basic()
        {
            ...
            Assert.AreEqual(4000, route.Climbs[0].Lenght);
            Assert.AreEqual(0, route.Climbs[0].InitKm);
            Assert.AreEqual(300, route.Climbs[0].Elevation);
            Assert.AreEqual(0, route.Climbs[0].InitAltitude);
            Assert.AreEqual(300, route.Climbs[0].MaxAltitude);
            Assert.AreEqual(7.5, route.Climbs[0].Slope);
